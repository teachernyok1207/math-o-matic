...
export default function App() {
    ...
    const gamePlayButtons = [
        <GetNewProblemButton
            ...
            hidden={!gameStarted}
        />,
        <CheckAnswerButton disabled={recentCorrectAnswer} key={nanoid()} hidden={!gameStarted} />,
    ]

    const startButton = (
        <StartButton clickHandler={() => setGameStarted(true)} hidden={gameStarted} />
    )
...
*/
    ...
    return (
        <div className="wrapper">  
            ...
            <h1 hidden={gameStarted}>Math-o-Matic</h1>

            <form onSubmit={handleSubmit}>
            
                <label hidden={!gameStarted}>
